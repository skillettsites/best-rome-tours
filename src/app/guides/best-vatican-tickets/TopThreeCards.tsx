        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-[280px_1fr]">
            <TrackedGYGLink
              ...
              section="vatican-which-ticket-image"
            ...
            <div className="flex flex-col p-5 sm:p-6">
              ...
              <dl className="mt-4 grid grid-cols-2 gap-x-4 gap-y-2 text-sm text-gray-700 sm:grid-cols-3">
                <div>
                  ...
                  <dd className="font-semibold text-gray-900">
                    <LocalPrice amount={ticket.gbpFrom} currency="GBP" />
                  </dd>
                </div>
                <div>
                ...
                <div>
                  <dt className="text-xs uppercase tracking-wide text-gray-500">St Peter&apos;s included</dt>
                  <dd className="font-semibold text-gray-900">{ticket.includesBasilica ? 'Yes' : 'No'}</dd>
                </div>
                <div>
                  <dt className="text-xs uppercase tracking-wide text-gray-500">Skip the line</dt>
                  <dd className="font-semibold text-gray-900">{ticket.skipTheLine ? 'Yes' : 'No'}</dd>
                </div>
                <div>
              ...
              <TrackedGYGLink
                href={ticket.href}
                tourName={ticket.shortName}
                section="vatican-which-ticket-cta"
                destination={ticket.bestFor}
