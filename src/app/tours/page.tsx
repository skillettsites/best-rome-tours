...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'All Rome Tours & Attractions 2026',
    description: 'Browse and book the best Rome tours and attractions. Best prices, instant confirmation.',
    url: `${SITE_URL}/tours`,
  },
};
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">All Rome Tours & Attractions</h1>
        ...
        <section className="mt-12 bg-gray-50 rounded-xl p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Rome Travel Guides</h2>
          <p className="text-gray-600 mb-4">Not sure where to start? Our guides help you plan the perfect Rome trip.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {guides.slice(0, 6).map(guide => (
              ...
              >
                <h3 className="font-medium text-gray-900 text-sm">{displayCopy(guide.title)}</h3>
                <p className="text-xs text-gray-500 mt-1 line-clamp-2">{displayCopy(guide.excerpt)}</p>
              </Link>
            ))}
          </div>
          <div className="mt-4">
