...
export const metadata: Metadata = {
  ...
  description: 'Expert Rome travel guides covering first-time tips, one-day itineraries, free things to do, food tours, seasonal advice, and day trip ideas.',
  alternates: { canonical: `${SITE_URL}/guides` },
  openGraph: {
    title: 'Rome Travel Guides 2026',
    description: 'Expert Rome travel guides covering first-time tips, one-day itineraries, free things to do, and more.',
    url: `${SITE_URL}/guides`,
  },
};
...
export default function GuidesPage() {
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">Rome Travel Guides</h1>
        <p className="mt-3 text-lg text-gray-600 max-w-3xl">
          Expert tips, itineraries, and insider advice to help you plan the perfect Rome trip.
        </p>
      </div>
