...
export const attractions: Attraction[] = [
  {
    ...
    faqs: [
      ...
      { question: 'What is the best Colosseum tour?', answer: 'The top-rated option is the Colosseum, Roman Forum & Palatine Hill Guided Tour, rated 4.8 stars by 85,952 travellers, from £42.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What is the best Vatican Museums tour?', answer: 'The top-rated option is the Rome: Vatican Museums, Sistine Chapel & Basilica Tour, rated 4.7 stars by 16,540 travellers, from £64. For skip-the-line entry without a guide, the Vatican Museums & Sistine Chapel Entrance Ticket starts from £28.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What is the best St Peter’s Basilica tour?', answer: 'The top-rated option is the St Peter\'s Basilica, Dome Climb and Underground Tour, rated 4.7 stars by 5,369 travellers, from £28. For the papal tombs on a budget, the Dome Climb & Papal Tombs tour starts from £16 and a pre-reserved entry ticket from £10.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What is the best Roman Forum tour?', answer: 'The top-rated option is the Colosseum, Roman Forum & Palatine Hill Guided Tour, rated 4.8 stars by 85,952 travellers, from £42. The same ticket covers all three sites.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What is the best Roman catacombs tour?', answer: 'For most visitors, the St Peter’s Basilica, Dome Climb & Papal Tombs tour, rated 4.5 stars by 3,220 travellers, from £16. It covers the Vatican Grottoes and the tombs of St Peter with a guide. The pre-reserved St Peter’s Basilica ticket, rated 4.3 by 1,106 travellers, does the same site from £10 without a guide.' },
  ...
  },
  {
    ...
    metaDescription: 'Book Trevi Fountain tours in Rome from £21, including the subterranean aqueducts beneath the fountain. Instant confirmation and free cancellation on most options.',
