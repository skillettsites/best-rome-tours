        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/best-time-to-visit-rome" className="text-sm hover:text-white transition-colors inline-flex items-center min-h-[32px]">Best Time to Visit</Link></li>
